...
export default {
  ...
  setup(props, context) {
    ...
    const init = {
      ...
      // images_upload_url: 'https://gateway-test.moerlong.com/mdm/api/oss/qiniu/uploadHttps',  //后端处理程序的url
    ...
    watch(() => props.modelValue, (initInfo, prevInitInfo) => {
        content.value = props.modelValue;
      }
    );

    watch(() => content.value, (initInfo, prevInitInfo) => {
        revert_data(content);
      }
    );
