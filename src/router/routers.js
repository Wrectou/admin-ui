...
export const routes = [{
    ...
    },
    {
        ...
        children: [
            ...
            //     noCache: true,
            //     hidden: true,
            //     component: () => import ("@/views/questionAdmin/test/add"),
            //     name: "questionAdminAddTest",
            ...
            // },
            {
                ...
                noCache: true,
                hidden: true,
                component: () => import ("@/views/questionAdmin/test/specialList"),
                name: "questionAdminSpecialTestList",
                meta: { title: "考试试卷管理", icon: "dict" },
            },
            // {
            //     path: "addSpecial",
            //     noCache: true,
            //     hidden: true,
            //     component: () => import ("@/views/questionAdmin/test/addSpecial"),
